...
class SchedulerModule extends PrivateModule {
    ...
    SchedulerModule(Collection<Class<?>> taskClasses, Scheduler scheduler,
            Multimap<Class<? extends Task>, Class<? extends TaskListener>> taskListenerMap) {
    ...
    protected void configure() {
        ...
        for (Map.Entry<Class<? extends Task>, Class<? extends TaskListener>> taskListenerEntry : taskListenerMap
                .entries()) {
